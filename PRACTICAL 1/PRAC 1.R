...
segments(x0=1500, y0=0, x1=0, y1=1000, col="green")
segments(x0=2000, y0=0, x1=600, y1=0, col="green")

optimum <- lp(direction="max", objective.in=C,
              const.mat=A, const.dir=constraints_direction,
              const.rhs=B,
              all.int=T)
